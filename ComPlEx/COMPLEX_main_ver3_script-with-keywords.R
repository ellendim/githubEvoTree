...
species1_keyword <- "Scots" # c("Cher","Nor","Asp" , "Scots", "Birch" )
species2_keyword <- "Birch" # c("Cher","Nor","Asp" , "Scots", "Birch" )
...
file <- paste0("Data/DATA/orthologs-",species1_keyword,"-",species2_keyword,".RData")
...
if (!file.exists(file)){ 
    ...
    comparison_RData <- paste0("Data/DATA/comparison-", species1_keyword, "-", species2_keyword, "-", 
