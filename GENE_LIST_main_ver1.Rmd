...
save(expr_genes, file = "Data/DATA/textFiles/all_expressed_genes.RData")
...
write.table(partial3_genes_all_species, "Data/DATA/textFiles/partial3_genes_all_species.txt", row.names=FALSE)

write.table(partial3_genes_angiosperms, "Data/DATA/textFiles/partial3_genes_angiosperms.txt", row.names=FALSE)
