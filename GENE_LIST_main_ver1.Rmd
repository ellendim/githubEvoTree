...
# Use r-data
write.table(significant_genes, "~/NMBU/M60-BIAS/EvoTree/githubEvoTree/Upset_plot/significant_genes.txt", row.names=FALSE)
write.table(coexpr_genes, "~/NMBU/M60-BIAS/EvoTree/githubEvoTree/Upset_plot/all_co-expressed_genes.txt", row.names=FALSE)
write.table(cons_genes_all_species, "~/NMBU/M60-BIAS/EvoTree/githubEvoTree/Upset_plot/cons_genes_all_species.txt", row.names=FALSE)
write.table(cons_genes_angiosperms, "~/NMBU/M60-BIAS/EvoTree/githubEvoTree/Upset_plot/cons_genes_angiosperms.txt", row.names=FALSE)
write.table(cons_genes_gymnosperms, "~/NMBU/M60-BIAS/EvoTree/githubEvoTree/Upset_plot/cons_genes_gymnosperms.txt", row.names=FALSE)
write.table(strictly_conserved_aspen, "~/NMBU/M60-BIAS/EvoTree/githubEvoTree/Upset_plot/cons_genes_aspen.txt", row.names=FALSE)

write.table(strictly_gymnos_aspen, "~/NMBU/M60-BIAS/EvoTree/githubEvoTree/Upset_plot/gymnosperms_genes_aspen.txt", row.names=FALSE)

write.table(strictly_angios_aspen, "~/NMBU/M60-BIAS/EvoTree/githubEvoTree/Upset_plot/angiosperms_genes_aspen.txt", row.names=FALSE)
