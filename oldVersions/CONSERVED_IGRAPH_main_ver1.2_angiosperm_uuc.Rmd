...
expressologs <- read.delim("Data/DATA/textFiles/cons_genes_angiosperms.txt", sep = " ") %>% 
...
species_names <- c("AspWood", "BirchWood", "CherWood")
species_names_short <- gsub("Wood", "", species_names)
tree_names <- c("A1", "B1", "C1")
...
save(uuc_genes_asp, file ="Data/DATA/uuc_orthologs_angiosperms_asp.RData")
