...
corr_matrix <- round(cor( nor_expr_sort_comp, asp_expr_sort_comp, method = "pearson"), 4)
...
heat_2 <-  Heatmap(corr_matrix, column_title = "Asp-Nor",
                    width = ncol(corr_matrix)*unit(5, "mm"), 
    height = nrow(corr_matrix)*unit(5, "mm"),
    row_order = 1:ncol(nor_expr_sort_comp),
