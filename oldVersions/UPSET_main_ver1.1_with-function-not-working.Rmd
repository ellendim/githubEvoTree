...
row_FUNC(ortho_angio)
removable_gymnos <- rows_to_be_removed


# ANGIOS
rows_to_be_removed <- c()
row_FUNC(ortho_gymnos)
...
paste0("Number of ortho groups unique to angiosperms: ", nrow(ortho_gymnos))
...
input <- c(
  "Asp&Birch&Cher&Nor&Scots&Lodge" = nrow(ortho_all),
...
- use individual corr scales + add a small hm with the max corr value, what does very red mean for all plots?
- use p-vals 0.02! experiment, its ok as the values are fdr corrected
