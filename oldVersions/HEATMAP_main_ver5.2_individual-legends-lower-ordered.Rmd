...
corr_list <- c("corr_Cher-Asp", "corr_Birch-Asp", "corr_Lodge-Asp", "corr_Nor-Asp", "corr_Scots-Asp", "corr_Cher-Birch", "corr_Nor-Birch", "corr_Nor-Cher", "corr_Scots-Birch", "corr_Scots-Cher", "corr_Scots-Nor", "corr_Lodge-Birch", "corr_Lodge-Cher", "corr_Lodge-Nor", "corr_Lodge-Scots")
...
for(matrix in corr_list){
   ...
   hm <-  Heatmap(get(matrix),show_column_names = FALSE, 
    ...
    column_order = 1:ncol(get(matrix)), name = "corr") 
...
for(i in file_list_2){
  ...
  hm <-  Heatmap(corr_matrix,show_column_names = FALSE,
    ...
    row_order = 1:nrow(corr_matrix),
    column_order = 1:ncol(corr_matrix), name  = "Corr" )

    new_name <- as.character(paste0("hm-",species, "-",species))
    mv("hm", new_name)
...
First plot will be added in space 1, second plot in space 2 etc.
...
grid.arrange(
  grobs = c(tree_as_grob, hm), layout_matrix = layout_matrix
)
