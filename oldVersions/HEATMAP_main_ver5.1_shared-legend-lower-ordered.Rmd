...
for(i in file_list_2){
  ...
  hm <-  Heatmap(corr_matrix,column_title = paste0(species,"-", species),show_column_names = FALSE,
                show_row_names = FALSE,
    column_title_gp = gpar(fontsize = 15),
    ...
    column_order = 1:ncol(corr_matrix), col = col_function_1, show_heatmap_legend = F )
...
# Vertical main -with diags
 ...
 plot_grid(g16,NULL, NULL, NULL, NULL, NULL,
          ...
          g2, g3, g18, NULL, NULL, lgd_1_grob,
...
#           g2, g3, NULL, NULL, NULL, lgd_1_grob, 
