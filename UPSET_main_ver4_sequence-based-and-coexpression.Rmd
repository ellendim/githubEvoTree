...
for (i in col_order_singles){
  ...
  col_renamed <- as.character(paste0(i, " "))
...
ones_and_zeros_all_saved <- save(ones_and_zeros_all, file = "Data/DATA/ones_and_zeros_all.RData")
